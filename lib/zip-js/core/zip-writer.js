import { UNDEFINED_TYPE, UNDEFINED_VALUE, INFINITY_VALUE, MAX_16_BITS, MAX_32_BITS, MAX_8_BITS, OBJECT_TYPE, DIRECTORY_SIGNATURE, FILE_ATTR_UNIX_SETUID_MASK, FILE_ATTR_UNIX_SETGID_MASK, FILE_ATTR_UNIX_STICKY_MASK, FILE_ATTR_UNIX_TYPE_DIR, ZIP64_END_OF_CENTRAL_DIR_LENGTH, ZIP64_END_OF_CENTRAL_DIR_LOCATOR_LENGTH, HEADER_SIZE, FILE_ATTR_MSDOS_ARCHIVE_MASK, FILE_ATTR_MSDOS_DIR_MASK, FILE_ATTR_MSDOS_SYSTEM_MASK, FILE_ATTR_MSDOS_HIDDEN_MASK, FILE_ATTR_MSDOS_READONLY_MASK, VERSION_DEFLATE, EXTRAFIELD_TYPE_ZIP64, EXTRAFIELD_TYPE_AES, EXTRAFIELD_TYPE_EXTENDED_TIMESTAMP, EXTRAFIELD_TYPE_NTFS, EXTRAFIELD_TYPE_NTFS_TAG1, EXTRAFIELD_TYPE_INFOZIP, EXTRAFIELD_TYPE_UNIX, COMPRESSION_METHOD_DEFLATE, COMPRESSION_METHOD_STORE, VERSION_ZIP64, VERSION_AES, COMPRESSION_METHOD_AES, MIN_DATE, MAX_DATE, LOCAL_FILE_HEADER_SIGNATURE, HEADER_OFFSET_COMPRESSED_SIZE, HEADER_OFFSET_UNCOMPRESSED_SIZE, DATA_DESCRIPTOR_RECORD_SIGNATURE, SPLIT_ZIP_FILE_SIGNATURE, EXTRAFIELD_TYPE_USDZ, HEADER_OFFSET_SIGNATURE, ZIP64_END_OF_CENTRAL_DIR_TOTAL_LENGTH, END_OF_CENTRAL_DIR_LENGTH, FILE_ATTR_UNIX_EXECUTABLE_MASK, FILE_ATTR_UNIX_DEFAULT_MASK, DATA_DESCRIPTOR_RECORD_ZIP_64_LENGTH, DATA_DESCRIPTOR_RECORD_LENGTH, DATA_DESCRIPTOR_RECORD_SIGNATURE_LENGTH, CENTRAL_FILE_HEADER_SIGNATURE, ZIP64_END_OF_CENTRAL_DIR_SIGNATURE, ZIP64_END_OF_CENTRAL_DIR_LOCATOR_SIGNATURE, END_OF_CENTRAL_DIR_SIGNATURE, BITFLAG_LANG_ENCODING_FLAG, BITFLAG_DATA_DESCRIPTOR, COMPRESSION_METHOD_DEFLATE_64, BITFLAG_LEVEL_SUPER_FAST_MASK, BITFLAG_LEVEL_FAST_MASK, BITFLAG_LEVEL_MAX_MASK, BITFLAG_ENCRYPTED } from "./constants.js";
import { getConfiguration, getChunkSize } from "./configuration.js";
import { codec } from "./codec.js";
import { CODEC_DEFLATE } from "./streams/codec-stream.js";
import { GenericWriter, GenericReader, initStream } from "./io.js";
import { encodeText } from "./util/encode-text.js";
import { PROPERTY_NAME_DIRECTORY, PROPERTY_NAME_COMMENT, PROPERTY_NAME_EXTRA_FIELD, PROPERTY_NAME_UNCOMPRESSED_SIZE, PROPERTY_NAME_SIGNATURE, Entry, PROPERTY_NAME_UID, PROPERTY_NAME_GID, PROPERTY_NAME_UNIX_MODE, PROPERTY_NAME_MSDOS_ATTRIBUTES_RAW, PROPERTY_NAME_MSDOS_ATTRIBUTES, PROPERTY_NAME_VERSION_MADE_BY, PROPERTY_NAME_MS_DOS_COMPATIBLE, PROPERTY_NAME_SETUID, PROPERTY_NAME_SETGID, PROPERTY_NAME_STICKY, PROPERTY_NAME_VERSION, PROPERTY_NAME_ZIPCRYPTO, PROPERTY_NAME_ZIP64, PROPERTY_NAME_COMPRESSION_METHOD, PROPERTY_NAME_ENCRYPTED, PROPERTY_NAME_EXTERNAL_FILE_ATTRIBUTES, PROPERTY_NAME_INTERNAL_FILE_ATTRIBUTES, PROPERTY_NAME_CREATION_DATE, PROPERTY_NAME_LAST_ACCESS_DATE, PROPERTY_NAME_LAST_MODIFICATION_DATE, PROPERTY_NAME_EXECUTABLE } from "./zip-entry.js";
import { OPTION_OFFSET, OPTION_USDZ, OPTION_PREVENT_CLOSE, OPTION_UNIX_EXTRA_FIELD_TYPE, OPTION_ENCODE_TEXT, OPTION_PASS_THROUGH, OPTION_ENCRYPTION_STRENGTH, OPTION_SIGNAL, OPTION_DATA_DESCRIPTOR_SIGNATURE, OPTION_DATA_DESCRIPTOR, OPTION_USE_UNICODE_FILE_NAMES, OPTION_KEEP_ORDER, OPTION_CREATE_TEMP_STREAM, OPTION_BUFFERED_WRITE, OPTION_EXTENDED_TIMESTAMP, OPTION_TRANSFER_STREAMS, OPTION_LEVEL, OPTION_SUPPORT_ZIP64_SPLIT_FILE, OPTION_PASSWORD, OPTION_RAW_PASSWORD } from "./options.js";
import { ZipReader } from "./zip-reader.js";
import { DecompressionStream as x_, CompressionStream as s_ } from "./streams/zlib-js/zlib-streams.js";
const zlibCfg = {
  CompressionStream: typeof CompressionStream != UNDEFINED_TYPE ? CompressionStream : s_,
  CompressionStreamZlib: s_,
  DecompressionStream: typeof DecompressionStream != UNDEFINED_TYPE ? DecompressionStream : x_,
...
function getHeaderInfo(options) {
  ...
  if (zip64) {
    ...
    if (zip64ExtraFieldComplete) {
      const rawLocalExtraFieldZip64View2 = getDataView(rawLocalExtraFieldZip64);
...
async function closeFile(zipWriter, comment, options) {
  ...
  for (const [, fileEntry] of files) {
    ...
    if (zip64Offset || zip64DiskNumberStart || zip64UncompressedSize || zip64CompressedSize) {
      ...
      if (zip64DiskNumberStart) {
        setUint32(zip64View, zip64FieldOffset, fileEntry.diskNumberStart);
      }
    } else {
      rawExtraFieldZip64 = new Uint8Array();
    }
  ...
  for (const [indexFileEntry, fileEntry] of Array.from(files.values()).entries()) {
    ...
    directoryOffset2 += 4;
    setUint32(directoryView, directoryOffset2, zip64Offset ? MAX_32_BITS : fileEntryOffset);
    directoryOffset2 += 4;
