import { initStream, TextWriter, BlobWriter, Data64URIWriter, Uint8ArrayWriter, BlobReader, TextReader, Data64URIReader, Uint8ArrayReader, HttpReader, Reader } from "./io.js";
...
import { ERR_INVALID_PASSWORD } from "./streams/common-crypto.js";
import "./streams/zip-entry-stream.js";
import "./streams/codec-stream.js";
class ZipEntry {
...
function addFileSystemHandle(zipEntry, handle, options) {
  ...
  async function addFile(parentEntry, handle2, addedEntries) {
    if (handle2) {
      try {
